...
print("saved topo_lookup_tbl to ./para_lookup_tbl/topo_lookup_tbl_GE.json")
with open('./para_lookup_tbl/topo_lookup_tbl_GE.json', 'w') as fp:
    json.dump(topo_lookup_tbl, fp, indent=4)

print("saved scan_lookup_tbl to ./para_lookup_tbl/scan_lookup_tbl_GE.json")
with open('./para_lookup_tbl/scan_lookup_tbl_GE.json', 'w') as fp:
    json.dump(scan_lookup_tbl, fp, indent=4)

print("saved recon_lookup_tbl to ./para_lookup_tbl/recon_lookup_tbl_GE.json")
with open('./para_lookup_tbl/recon_lookup_tbl_GE.json', 'w') as fp:
    json.dump(recon_lookup_tbl, fp, indent=4)

print("saved monitoring_scan_lookup_tbl to ./para_lookup_tbl/monitoring_scan_lookup_tbl_GE.json")
with open('./para_lookup_tbl/monitoring_scan_lookup_tbl_GE.json', 'w') as fp:
