...
target_file = 'G:\My Drive\BCH\Rotations\Informatics\CT wiki\GE_Optima660\service_mod_data\service_mod_data\system_state\chest_3.proto'
...
def convert_protocol_from_indiv_prot_xml_to_json(topo_lookup_tbl_json_path,
    ...
    for i in range(0,len(res)):
        ...
        # seen = set()
        # prot_se_list_set = []
        # for d in prot_se_list:
        #     t = tuple(d.items())
        #     if t not in seen:
        #         seen.add(t)
        #         prot_se_list_set.append(d)
                
        # seen = set()
        # prot_dict_list_set = []
        # for d in prot_dict_list:
        #     t = tuple(d.items())
        #     if t not in seen:
        #         seen.add(t)
        #         prot_dict_list_set.append(d)
...
# unit testing
topo_lookup_tbl_json_path = "./para_lookup_tbl/topo_lookup_tbl_GE.json"
scan_lookup_tbl_json_path = "./para_lookup_tbl/scan_lookup_tbl_GE.json"
recon_lookup_tbl_json_path = "./para_lookup_tbl/recon_lookup_tbl_GE.json"
#bolus_lookup_tbl_json_path = "./para_lookup_tbl/bolus_lookup_tbl.json"
monitoring_scan_lookup_tbl_json_path = "./para_lookup_tbl/monitoring_scan_lookup_tbl_GE.json"
...
# target_prot_name_list = ["chest_3.proto"]
# common_prot_name = "Chest 3"

target_prot_name_list = ["head_9.proto","head_10.proto"]
common_prot_name = "Head Acute Stroke"
...
for i, target_prot_name in enumerate(target_prot_name_list):
    ...
    protocol_file_folder = "G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\GE_Optima660"
