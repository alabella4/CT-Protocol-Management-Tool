...
import re
import glob
from get_para_from_indiv_prot_xml_SPECT import get_para_from_indiv_prot_xml_Siemens_Force
import json
...
target_file = 'G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\SPECT-CT_UserProtocols\\Import\MlThorax\CHEST_OVER_55KG_CLASS_1_R.MlAdult'
    ...
    for i in range(0,len(res)):
        ...
        if any('MlTopo' in sub for sub in sub_protocol[i]) == True:              
            for key in topo_lookup_tbl:
                ...
                para = globals()[target_func_name](sub_protocol[i],
                                                   bool_verbose=False,
                                                   **para_dict)
                dict1[key] = para[1]
...
# unit testing
topo_lookup_tbl_json_path = "./para_lookup_tbl/topo_lookup_tbl_S.json"
scan_lookup_tbl_json_path = "./para_lookup_tbl/scan_lookup_tbl_S.json"
recon_lookup_tbl_json_path = "./para_lookup_tbl/recon_lookup_tbl_S.json"
bolus_lookup_tbl_json_path = "./para_lookup_tbl/bolus_lookup_tbl.json"
monitoring_scan_lookup_tbl_json_path = "./para_lookup_tbl/monitoring_scan_lookup_tbl_S.json"
...
target_prot_name_list = ["CT_CHEST_CLS_1_UNDER_55KG_R.MlChild"]
common_prot_name = "Pediatric Chest"
