...
scan_lookup_tbl_json_path = "./para_lookup_tbl/scan_AB_lookup_tbl.json"
...
target_prot = "\\Import\\DualEnergy\\DE_Body_BoneMarrow.Adult"
common_prot_name = "BoneMarrowAdult"

target_prot_name_list = ["\\UserProtocols_2022-09-28","\\UserProtocols_2022-10-25"]

# target_prot = "\\Import\\Abdomen\\ColonCAD.Adult"
# common_prot_name = "AbdomenColonCAD"

# target_prot = "\\Import\\Abdomen\\TF_ABDOMEN_OVER_55KG_CLASS_1.Adult"
# common_prot_name = "AbdomenClass1"
...
for i, target_prot_name in enumerate(target_prot_name_list):
    ...
    target_prot_xml_path_list.append(glob.glob(protocol_file_folder + "\\**\\" + target_prot_file_name + target_prot, recursive=True)[0])
