...
target_prot_name_list = ['UserProtocols_2020-06', 'UserProtocols_2022-02-09']
#target_prot_name_list = ['UserProtocols_2020-06', 'UserProtocols_2023-08-10']
#target_prot_name_list = ['UserProtocols_2022-02-09', 'UserProtocols_2023-08-10']
#target_prot_name_list = ['UserProtocols_2022-02-09', 'UserProtocols_2022-09-28']
#target_prot_name_list = ['UserProtocols_2022-09-28', 'UserProtocols_2023-04-25']
#target_prot_name_list = ['UserProtocols_2023-04-25', 'UserProtocols_2023-08-10']
...
for i, target_prot_name in enumerate(target_prot_name_list):
    ...
    protocol_file_folder = "G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force"
...
onlyprots_2022 = onlyprots[0]
onlyprots_2023 = onlyprots[1]
onlyprotnames_2022 = []
onlyprotnames_2023 = []

for x in onlyprots_2022:
    onlyprotnames_2022.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2020-06\\'))
for x in onlyprots_2023:
    onlyprotnames_2023.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2022-02-09\\'))

# # for x in onlyprots_2022:
#     onlyprotnames_2022.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2020-06\\'))
# for x in onlyprots_2023:
#     onlyprotnames_2023.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2023-08-10\\'))

# for x in onlyprots_2022:
#     onlyprotnames_2022.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2022-02-09\\'))
# for x in onlyprots_2023:
#     onlyprotnames_2023.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2023-08-10\\'))
...
#     onlyprotnames_2022.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2022-02-09\\'))
# for x in onlyprots_2023:
#     onlyprotnames_2023.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2022-09-28\\Import\\'))

# for x in onlyprots_2022:
#     onlyprotnames_2022.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2022-09-28\\Import\\'))
# for x in onlyprots_2023:
#     onlyprotnames_2023.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2023-04-25\\Import\\'))

# for x in onlyprots_2022:
#     onlyprotnames_2022.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2023-04-25\\Import\\'))
# for x in onlyprots_2023:
#     onlyprotnames_2023.append(x.removeprefix('G:\\My Drive\\BCH\\Rotations\\Informatics\\CT wiki\\Siemens_Force\\UserProtocols_2023-08-10\\'))

inbothyears = list(set(onlyprotnames_2023).intersection(onlyprotnames_2022))
notin2022 = list(set(onlyprotnames_2023).difference(onlyprotnames_2022))
notin2023 = list(set(onlyprotnames_2022).difference(onlyprotnames_2023))
tot_2022 = len(onlyprotnames_2022)
tot_2023 = len(onlyprotnames_2023)
...
for x in inbothyears:
    ...
    xlsx_path = protocol_file_folder + "\\2020-06 vs 2022-02-09\\" + common_prot_name + '.xlsx'
    #xlsx_path = protocol_file_folder + "\\2020-06 vs 2023-08-10\\" + common_prot_name + '.xlsx'
    #xlsx_path = protocol_file_folder + "\\2022-02-09 vs 2023-08-10\\" + common_prot_name + '.xlsx'
    #xlsx_path = protocol_file_folder + "\\2022-02-09 vs 2022-09-28\\" + common_prot_name + '.xlsx'
    #xlsx_path = protocol_file_folder + "\\2022-09-28 vs 2023-04-25\\" + common_prot_name + '.xlsx'
    #xlsx_path = protocol_file_folder + "\\2023-04-25 vs 2023-08-10\\" + common_prot_name + '.xlsx'
    ...
    if 'Cardiac' in x:
        ...
        scan_lookup_tbl_json_path = "./para_lookup_tbl/scan_lookup_tbl.json"
        scan_AB_lookup_tbl_json_path = "./para_lookup_tbl/scan_AB_lookup_tbl_new.json"
        ...
        monitoring_scan_lookup_tbl_json_path = "./para_lookup_tbl/monitoring_C_scan_lookup_tbl.json"
    ...
    #     if 1:
    #         convert_protocol_from_indiv_prot_xml_to_json_DE(topo_lookup_tbl_json_path,
    #                                                         scan_lookup_tbl_json_path,
    #                                                         scan_AB_lookup_tbl_json_path,
    #                                                         recon_lookup_tbl_json_path,
    #                                                         monitoring_scan_lookup_tbl_json_path,
    ...
    #         convert_protocol_from_json_to_xlsx_DE(x,
    #                                               prot_list_json_path,
    #                                               output_xlsx_path=xlsx_path,
    #                                               bool_verbose=False,
    #                                               bool_debug=False)
